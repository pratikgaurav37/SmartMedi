    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
            ...
            <div className="bg-white p-6 shadow-sm sticky top-0 z-10">
                <h2 className="text-xl font-bold text-center text-slate-800">Setup Profile</h2>
            ...
            <div className="flex-1 p-6 max-w-md w-full mx-auto flex flex-col">
                ...
                {step === 2 && (
                    <div className="space-y-6 flex-1 animate-in fade-in slide-in-from-right-4 duration-300">
                        <h3 className="text-lg font-semibold text-slate-900">Health Context</h3>
                                    ...
                                    >
                                        ...
                                        <button
                                            onClick={() =>
                                                setFormData({
                                                    ...formData,
                                                    conditions: formData.conditions.filter((_, idx) => idx !== i),
                                                })
                                            }
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-sm font-medium text-slate-700">Doctor Name (Optional)</label>
                            <Input
                ...
                {step === 3 && (
                    <div className="space-y-6 flex-1 animate-in fade-in slide-in-from-right-4 duration-300">
                        ...
                        <Select
                            ...
                            onChange={(e) => setFormData({ ...formData, preferences: { ...formData.preferences, reminderTone: e.target.value } })}
                            className="bg-white"
                        >
                        ...
                        <div className="pt-6 border-t border-slate-100">
                            ...
                            <p className="text-xs text-slate-500 mb-4">
                                Connect your Telegram account to receive medication reminders directly in Telegram.
                            </p>
                            <TelegramWidget
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 flex space-x-4">
                    ...
                    <Button
                        ...
                        disabled={(step === 1 && (!formData.name || !formData.phone)) || isSubmitting}
                    >
                        {step < 3 ? (
                            <>
